...
def setup_lia_for_pulsed_measurements(daq,edge, phase=190, repetitions=1, num_repeat=100, number_of_points=100, cyc_time=250e-6):
    ...
    daq.setDouble('/dev30496/demods/0/timeconstant', 0.003192064919005009) # filter for 130Hz lock-in freq
    ...
    # daq_module.set('triggernode', '/dev30496/demods/0/sample.R')
